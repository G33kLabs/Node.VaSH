module.exports =  {
    ...
    assets: {
        ...
        js: ['/common/js/jquery.min.js', '/common/js/async.min.js', '/common/js/date.min.js', '/common/js/mustache.min.js', '/common/js/underscore.min.js', '/common/js/backbone.min.js', '/common/js/jsclass.min.js', '/common/js/bootstrap.js', '/common/js/jquery.gatracker.js', '/assets/js/app.js']
    },
